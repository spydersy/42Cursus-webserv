...
/*   Updated: 2022/02/14 05:29:05 by abelarif         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class MimeTypes
{
    ...
    public:
        ...
        MimeTypes(Request REQUEST, std::vector<Server> CONF) :   _REQUEST(REQUEST),
                                                    _CONF(CONF),
                                                    _extension(""),
                                                    _contentType("") {
        ...
        std::string getExtension() { return this->_extension; }

        std::pair<std::string, std::string> get_mimetype() { return this->_mimetype; }
